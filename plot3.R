...
plot3 <- function() {
	...
	#create a line plot with time as x-axis, Sub_metering at y-axis
	#set the y-axis limit to overlay 2nd and third lines on same axes
	#add legend
	plot(current$Date_time,current$Sub_metering_1, type="l", ylim=c(0,35),yaxt="n", ylab="Energy sub metering", xlab="")
	axis(2, at=c(0,10,20,30))
	lines(current$Date_time,current$Sub_metering_2, col="red")
	lines(current$Date_time,current$Sub_metering_3, col="blue")
